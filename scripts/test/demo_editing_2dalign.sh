...
ckpt_path=pretrained_models/E3DGE_2DAlignOnly_Runner.pt
...
# ckpt_weight=0.01
# ckpt_path=final_organized_logs/checkpoints/V9/occlusion_runner_cycle_v9_hybridAlign_advLoss0.01_finetuneFromV7_models_latest.pt
weight=0.01
...
# --render_video \
# --editing_boundary_scale 0 $scale 0 \
# done
# --editing_boundary_scale 0 $scale 0 \

# ! output fixed scale now.
#  --adv_lambda $weight \
# --wandb \
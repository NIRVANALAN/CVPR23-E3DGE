...
# """
# no local branch version
runner=AERunner
exp_prefix=v1
ckpt_path=pretrained_models/Toonify/no_local_basic_trainer.pt
# """

checkpoints_dir=logs/toonify/${runner}_${exp_prefix}

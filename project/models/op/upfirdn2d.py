...
class UpFirDn2dBackward(Function):
    ...
    def forward(ctx, grad_output, kernel, grad_kernel, up, down, pad, g_pad,
        ...
        grad_input = grad_input.reshape(in_size[0], in_size[1], in_size[2],
                                        in_size[3])
    ...
    def backward(ctx, gradgrad_input):
        ...
        # gradgrad_out = gradgrad_out.reshape(ctx.in_size[0], ctx.out_size[0], ctx.out_size[1], ctx.in_size[3])
        gradgrad_out = gradgrad_out.reshape(ctx.in_size[0], ctx.in_size[1],
...
class UpFirDn2d(Function):
    ...
    def forward(ctx, input, kernel, up, down, pad):
        ...
        # out = out.reshape(major, out_h, out_w, minor)
        out = out.reshape(-1, channel, out_h, out_w)

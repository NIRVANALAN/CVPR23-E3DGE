...
import os
from OpenGL.GL import GL_COMPILE_STATUS, GL_FALSE, GL_FRAGMENT_SHADER, GL_GEOMETRY_SHADER, GL_LINK_STATUS, GL_VERTEX_SHADER, glAttachShader, glCompileShader, glCreateProgram, glCreateShader, glDetachShader, glGetProgramInfoLog, glGetProgramiv, glGetShaderInfoLog, glGetShaderiv, glLinkProgram, glShaderSource

...
class EvalDataset(Dataset):
    ...
    def get_render(self,
        ...
        view_ids = [(view_id + self.max_view_angle // num_views * offset) %
                    self.max_view_angle for offset in range(num_views)]
        if random_sample:
            view_ids = np.random.choice(self.max_view_angle,
                                        num_views,
                                        replace=False)

...
class HGPIFuNetGANResidualResnetFC(HGPIFuNetGAN):
    ...
    def __init__(self,
        ...
        self.downsample_channel_conv = conv(
            512, 64, 3, 1, norm='in')  # channel downsample img feature maps
    ...
    def build_modulation_net(self, opt_stylesdf):
        ...
        # hard to optimize, switch to raw MLP version in the released training script.

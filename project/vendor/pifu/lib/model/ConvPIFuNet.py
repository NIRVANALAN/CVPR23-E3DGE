...
from .ConvFilters import MultiConv, ResNet, Vgg16
...
class ConvPIFuNet(BasePIFuNet):
    ...
    def __init__(
        ...
        super(ConvPIFuNet, self).__init__(projection_mode=projection_mode,
    ...
    def query(self, points, calibs, transforms=None, labels=None):
        ...
        point_local_feat_list = [
            self.index(im_feat, xy) for im_feat in self.im_feat_list
        ]

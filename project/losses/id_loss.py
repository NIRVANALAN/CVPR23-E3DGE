...
from project.utils.misc.configs.paths_config import model_paths
from project.models.encoders.model_irse import Backbone
...
class IDLoss(nn.Module):
    ...
    def __init__(self, device):
        ...
        self.facenet.load_state_dict(
            torch.load(model_paths['ir_se50'], map_location=device))
